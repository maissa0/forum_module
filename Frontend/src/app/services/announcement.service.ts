...
export class AnnouncementService {
  ...
  createWithFile(formData: FormData): Observable<Announcement> {
    console.log('Service createWithFile called');
  ...
  updateWithFile(id: string, formData: FormData): Observable<Announcement> {
    const headers = { 'Authorization': `Bearer ${localStorage.getItem('token')}` };
    return this.http.put<Announcement>(`${this.apiUrl}/${id}`, formData, { headers });
  }
